...
export default function Home() {
  return (
    <div>
      ...
      <p>Welcome to StrangerHub, a unique platform where you can share your most intriguing experiences and strangest tales anonymously with fellow users who go by the name of Strangers.
